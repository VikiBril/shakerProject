...
<body>
    ...
    <body>
        <div id="bread_crumbs">
            <a href="frontPage.php"> דף הבית </a> /
            <a href="#"> הגדרות</a> /
            <a href="#">השייקים שלי </a>
        </div>
        <div id="wrapper">
            <div id="projpic"></div>
            <div id="proj_info"></div>
        </div>
        <div class="notesbox">
                <div class="row">
                    <div class="col-md">
                ...
                <div class="row">
                    <div class="col-md">
                        <a id="saveNotes"> Save </a>
                    </div>
                </div>
            </div>
    </body>
    <script src="shakeLogo.js"></script>
    <script src="SpecificData.js"></script>
